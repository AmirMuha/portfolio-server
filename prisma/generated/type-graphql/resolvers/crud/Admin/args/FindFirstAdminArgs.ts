...
export class FindFirstAdminArgs {
  ...
  distinct?: Array<"id" | "email" | "fname" | "lname" | "linkedIn" | "whatsapp" | "instagram" | "github" | "skype" | "heroImage" | "resumes" | "confirmed" | "apikey" | "password" | "createdAt" | "updatedAt"> | undefined;
}
